...
## Latest Mobile Release: v0.7.1-alpha.6.0

**Release page**: [mobile-v0.7.1-alpha.6.0](https://github.com/chancenhq/companion/releases/tag/mobile-v0.7.1-alpha.6.0)

### Direct Downloads

- **Android Debug APK**: [sure-v0.7.1-alpha.6.0-debug.apk](https://github.com/chancenhq/companion/releases/download/mobile-v0.7.1-alpha.6.0/sure-v0.7.1-alpha.6.0-debug.apk)
- **iOS Build (unsigned)**: [sure-v0.7.1-alpha.6.0-ios-unsigned.zip](https://github.com/chancenhq/companion/releases/download/mobile-v0.7.1-alpha.6.0/sure-v0.7.1-alpha.6.0-ios-unsigned.zip)
