...
## Latest Mobile Release: v0.7.1-alpha.7.8

**Release page**: [mobile-v0.7.1-alpha.7.8](https://github.com/chancenhq/companion/releases/tag/mobile-v0.7.1-alpha.7.8)

### Direct Downloads

- **Android APK**: [sure-v0.7.1-alpha.7.8.apk](https://github.com/chancenhq/companion/releases/download/mobile-v0.7.1-alpha.7.8/sure-v0.7.1-alpha.7.8.apk)
- **iOS Build (unsigned)**: [sure-v0.7.1-alpha.7.8-ios-unsigned.zip](https://github.com/chancenhq/companion/releases/download/mobile-v0.7.1-alpha.7.8/sure-v0.7.1-alpha.7.8-ios-unsigned.zip)
