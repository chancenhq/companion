...
## Latest Mobile Release: v0.7.11-alpha.7.19

**Release page**: [mobile-v0.7.11-alpha.7.19](https://github.com/chancenhq/companion/releases/tag/mobile-v0.7.11-alpha.7.19)

### Direct Downloads

- **Android APK**: [sure-v0.7.11-alpha.7.19.apk](https://github.com/chancenhq/companion/releases/download/mobile-v0.7.11-alpha.7.19/sure-v0.7.11-alpha.7.19.apk)
- **iOS Build (unsigned)**: [sure-v0.7.11-alpha.7.19-ios-unsigned.zip](https://github.com/chancenhq/companion/releases/download/mobile-v0.7.11-alpha.7.19/sure-v0.7.11-alpha.7.19-ios-unsigned.zip)
