...
## Latest Mobile Release: v0.7.1-alpha.7.6

**Release page**: [mobile-v0.7.1-alpha.7.6](https://github.com/chancenhq/companion/releases/tag/mobile-v0.7.1-alpha.7.6)

### Direct Downloads

- **Android APK**: [sure-v0.7.1-alpha.7.6.apk](https://github.com/chancenhq/companion/releases/download/mobile-v0.7.1-alpha.7.6/sure-v0.7.1-alpha.7.6.apk)
- **iOS Build (unsigned)**: [sure-v0.7.1-alpha.7.6-ios-unsigned.zip](https://github.com/chancenhq/companion/releases/download/mobile-v0.7.1-alpha.7.6/sure-v0.7.1-alpha.7.6-ios-unsigned.zip)
