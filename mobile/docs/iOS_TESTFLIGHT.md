...
- Bundle ID `com.chancen.companion` (or your custom value in the workflow)
...
For the `companion` package, use `vars.IOS_APP_BUNDLE_ID = com.chancen.companion` in repository Variables (or rely on the workflow default).
...
- Create and distribute an **App Store** provisioning profile for `com.chancen.companion`
